...
def count_words(subreddit, word_list, posts=[], after=None, session=None):
    ...
    try:
        ...
        if next:
            return count_words(subreddit, word_list, posts, next, session)

        freq = {word.lower(): 0 for word in word_list}
